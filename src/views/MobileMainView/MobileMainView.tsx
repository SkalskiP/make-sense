    ...
    const fourthStage = (
        <div className="FourthStage">
            <div className="Message">
                Due to the small size of the screen we do not support our editor
                on mobile devices. Check what you missed and visit us from a
                desktop.
            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(MobileMainView);
