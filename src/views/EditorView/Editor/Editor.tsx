...
class Editor extends React.Component<IProps, IState> {
    ...
    private mountEventListeners() {
        ...
        EditorModel.canvas.addEventListener(
    ...
    private update = (event: MouseEvent) => {
        ...
        EditorModel.mousePositionOnViewPortContent =
            CanvasUtil.getMousePositionOnCanvasFromEvent(
                event,
                EditorModel.canvas
            );
    ...
    public render() {
        return (
            <div
                ...
                />
                <div
                    className={EditorUtil.getCursorStyle(
                        this.props.customCursorStyle
                    )}
